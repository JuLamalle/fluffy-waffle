...
<div class="footer">
    <div class="footer-content">
        <div class="footer-section about">
            <h1 class="h1footer"><span>Sushi</span>Land</h1>
            <p>
            ...
            <div class="contact">
                ...
                <span><i class="fas fa-envelope"></i> &nbsp; etienne.cadoux@epitech.eu</span>
            </div>
            <div class="socials">
        ...
        <div class="footer-section links">
            <h2 class="h2footer">Quick Links</h2>
            <br>
            <ul>
        ...
        <div class="footer-section contact-form">
            <h2 class="h2footer">Contact us</h2>
            <br>
            <form action="index.html" method="post">
            <!-- Penser a ajouter une classe aux 2 inputs pour css le text (harmoniser avec tous les text input du site) -->
                <input type="email" name="contactemail" class="contact-input" placeholder="Your email adress...">
